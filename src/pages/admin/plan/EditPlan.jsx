...
const EditPlan = ({ editStatus, setEditStatus }) => {
  return (
    <div
    ...
    >
      <section className="flex justify-between items-center">
        ...
        <AiOutlineClose size={25} onClick={() => setEditStatus(false)} className="cursor-pointer"/>
      </section>
      <form action="" className="flex flex-col gap-y-5 my-10">
        ...
        <button
          className="btn-2 py-2 my-8 flex items-center justify-center gap-x-3 bg-dreamLabColor2"
          type="submit"
        >
          Save
        </button>
